        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VideoIntroPath = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ModuleRequests_Modules_ModuleId",
                        column: x => x.ModuleId,
                        principalTable: "Modules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ModuleRequests_Users_ReviewedBy",
                        column: x => x.ReviewedBy,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ModuleRequests_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PdfFilePath = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    MinimumDurationSeconds = table.Column<int>(type: "int", nullable: false),
                    ZipFilePath = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SubTopics_Trainings_TrainingId",
                        column: x => x.TrainingId,
                        principalTable: "Trainings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TrainingRequests_Users_ReviewedBy",
                        column: x => x.ReviewedBy,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsSessionActive = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ModuleRequests_ModuleId",
                table: "ModuleRequests",
                column: "ModuleId");

            migrationBuilder.CreateIndex(
                name: "IX_ModuleRequests_ReviewedBy",
                table: "ModuleRequests",
                column: "ReviewedBy");

            migrationBuilder.CreateIndex(
                name: "IX_ModuleRequests_Status",
                table: "ModuleRequests",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_ModuleRequests_UserId",
                table: "ModuleRequests",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_ModuleRequests_UserId_ModuleId_Status",
                table: "ModuleRequests",
                columns: new[] { "UserId", "ModuleId", "Status" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubTopics_IsActive",
                table: "SubTopics",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_SubTopics_OrderIndex",
                table: "SubTopics",
                column: "OrderIndex");

            migrationBuilder.CreateIndex(
                name: "IX_SubTopics_TrainingId",
                table: "SubTopics",
                column: "TrainingId");

            migrationBuilder.CreateIndex(
                name: "IX_TrainingRequests_ReviewedBy",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrainingRequests_UserId_TrainingId",
                table: "TrainingRequests",
                columns: new[] { "UserId", "TrainingId" });

            migrationBuilder.CreateIndex(
                name: "IX_Trainings_IsActive",
                table: "Trainings",
                column: "IsActive");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserModules_IsCompleted",
                table: "UserModules",
                column: "IsCompleted");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserProgresses_IsCompleted",
                table: "UserProgresses",
                column: "IsCompleted");

            migrationBuilder.CreateIndex(
                name: "IX_UserProgresses_LastAccessedDate",
                table: "UserProgresses",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserProgresses_UserId_SubTopicId",
                table: "UserProgresses",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserTrainings_IsCompleted",
                table: "UserTrainings",
                column: "IsCompleted");
